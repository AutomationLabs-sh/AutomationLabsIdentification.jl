...
@testset "Neural Network Builder linear modification algorithms" begin
    ...
    @test typeof(tuned_model_linear_0) ==
...
@testset "Neural Network Builder Fnn modification algorithms" begin
    ...
    @test typeof(tuned_model_fnn_4.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_fnn_5.model.model.optimiser) == Optim.OACCEL{
    ...
    @test typeof(tuned_model_fnn_11.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_fnn_12.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_fnn_18.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_fnn_19.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
...
@testset "Neural Network Builder Icnn modification algorithms" begin
    ...
    @test typeof(tuned_model_icnn_4.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_icnn_5.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_icnn_11.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_icnn_12.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_icnn_18.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_icnn_19.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
...
@testset "Neural Network Builder ResNet modification algorithms" begin
    ...
    @test typeof(tuned_model_resnet_4.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_resnet_5.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_resnet_11.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_resnet_12.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_resnet_18.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_resnet_19.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
...
@testset "Neural Network Builder densenet modification algorithms" begin
    ...
    @test typeof(tuned_model_densenet_4.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_densenet_5.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_densenet_11.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_densenet_12.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_densenet_18.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_densenet_19.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
...
@testset "Neural Network Builder polynet modification algorithms" begin
    ...
    @test typeof(tuned_model_polynet_4.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_polynet_5.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_polynet_11.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_polynet_12.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_polynet_18.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_polynet_19.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
...
@testset "Neural Network Builder rbf modification algorithms" begin
    ...
    @test typeof(tuned_model_rbf_4.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_rbf_5.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_rbf_11.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_rbf_12.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_rbf_18.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_rbf_19.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
...
@testset "Neural Network Builder rnn modification algorithms" begin
    ...
    @test typeof(tuned_model_rnn_4.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_rnn_5.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_rnn_11.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_rnn_12.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_rnn_18.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_rnn_19.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
...
@testset "Neural Network Builder lstm modification algorithms" begin
    ...
    @test typeof(tuned_model_lstm_4.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_lstm_5.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_lstm_11.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_lstm_12.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_lstm_18.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_lstm_19.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
...
@testset "Neural Network Builder gru modification algorithms" begin
    ...
    @test typeof(tuned_model_gru_4.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_gru_5.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_gru_11.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_gru_12.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_gru_18.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_gru_19.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
...
@testset "Neural Network Builder expn modification algorithms" begin
    ...
    @test typeof(tuned_model_expn_4.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_expn_5.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_expn_11.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_expn_12.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
    ...
    @test typeof(tuned_model_expn_18.model.model.optimiser) == Optim.LBFGS{
        Nothing,
        LineSearches.InitialStatic{Float64},
        LineSearches.HagerZhang{Float64,Base.RefValue{Bool}},
        Optim.var"#19#21",
    }
    @test typeof(tuned_model_expn_19.model.model.optimiser) == Optim.OACCEL{
        InitialStatic{Float64},
        Float64,
        GradientDescent{InitialStatic{Float64},Static,Nothing,Optim.var"#14#16"},
        HagerZhang{Float64,Base.RefValue{Bool}},
